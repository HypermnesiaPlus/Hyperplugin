        ...
        if(label.equalsIgnoreCase("renameitem")) {
            if(sender instanceof Player) {
                ...
                if (player.hasPermission("renameitem.use")) {
                	...
                	i.setItemMeta(im);
                    player.sendMessage(ChatColor.GREEN + "" + ChatColor.BOLD + "The item you were holding has been renamed to " + ChatColor.LIGHT_PURPLE + sb.toString());
                    return true;
